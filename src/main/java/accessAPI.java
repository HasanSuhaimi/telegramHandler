...
public class accessAPI {
    ...
    public static void main(String[] args) throws Exception {
        ...
        String CLIENT_ID = "557076360085-7g47kdj1gkmc3s8o3me7bvun11bilm3u.apps.googleusercontent.com";
        String CLIENT_SECRET = "oVOzNcmWaQcBUDcphrpl08gm";
        ...
        List<List<Object>> values = Arrays.asList(
                Arrays.asList(
                        // Cell values ...
                        "test","we will see","B","O","O","B","available"
                )
                // Additional rows ...
        );
        ...
        try {
            ...
            Sheets.Spreadsheets.Values.Append postRequest =
                    sheetsService.spreadsheets().values().append(spreadsheetId, "A1", requestBody);
